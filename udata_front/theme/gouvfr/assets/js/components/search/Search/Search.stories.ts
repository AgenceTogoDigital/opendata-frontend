                  ...
                  "recommendations-externals": [
                    {
                      ...
                      "messages": {
                        "en": {
                          ...
                          "message": "The national address website \u00ab\u00a0adresse.opendata.gouv.tg \u00a0\u00bb references all addresses in France and make them usable for all.",
                          "button": "Visit adresse.opendata.gouv.tg "
                        },
                        "fr": {
                          "title": "Vous souhaitez chercher une adresse dans la Base Adresse Nationale ou, pour les communes, g\u00e9rer vos adresses\u00a0?",
                          "message": "Le site national des adresses, adresse.opendata.gouv.tg , r\u00e9f\u00e9rence l\u2019int\u00e9gralit\u00e9 des adresses du territoire et les rend utilisables par toutes et tous.",
                          "button": "Consulter adresse.opendata.gouv.tg "
                        }
                      }
                    }
                  ],
...
const sampleResults = JSON.stringify([
  ...
  },
  {
    ...
    "description": "En raison de la mise à jour de ce jeu de données par ajout d'années supplémentaires, veuillez svp vous reporter au jeu de données \"Fichier des prénoms de 1900 à 2019\" sur opendata.gouv.tg .\n\n",
